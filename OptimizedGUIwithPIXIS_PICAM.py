        ...
        while self.cam_open:
            ...
            if self.paused == True:
                ...
                while self.paused == False:
                    ...
                    # exposure_time = int(self.ExpS.text()) 
